...
struct QEventTag {
    ...
    unsigned char attrQF__;                 /**< private attribute used  */
};
...
struct QFsmTag {
    ...
    */
    ...
    unsigned char tran__;        /**< transition attributes (none/dynamic/static) */
};
